...
import org.lsm.db.iterator.IteratorsComparator;
...
public class PersistentDao extends InMemoryDao {
    ...
    public class SortedStingTablesIterator implements Iterator<org.lsm.Entry<MemorySegment>> {
        ...
        private org.lsm.Entry<MemorySegment> minEntry;
        ...
        private org.lsm.Entry<MemorySegment> getNextEntry() {
            while (!set.isEmpty()) {
        ...
        @Override
        public org.lsm.Entry<MemorySegment> next() {
            var entry = minEntry;
